  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden [border-radius:var(--radius)] p-1.5 border border-white/10  px-6 whitespace-nowrap text-white [background:var(--bg)]",
